...
- distinguishing the components
  ...
  - `TestYourself.astro` - (*inside* a tutorial step/page) - sits anywhere in the document and contains simple multiple choice questions that the user answers to test their knowledge of the topic; the user can change their answer (as the purpose of the test is to clarify understanding)
